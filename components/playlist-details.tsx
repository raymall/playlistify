...
export const PlaylistDetails = ({
  ...
  <Dialog>
    ...
    <DialogContent className='max-h-[90dvh] grid-rows-[minmax(0,1fr)] overflow-hidden border-2 border-border sm:max-w-2xl'>
      <div className='grid min-h-0 gap-4 overflow-y-auto pr-1'>
        <DialogHeader className='border-b border-border pe-10 pb-5'>
